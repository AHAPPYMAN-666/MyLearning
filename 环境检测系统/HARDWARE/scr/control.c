...
{		
	...
	u1_printf("%s\r\n", tempAll+3);
	//u1_printf("总长度：%d\r\n",Init_len);
	MQTT_PublishQs0(S_TOPIC_NAME, tempAll, dataLen); //添加数据，发布给服务器topic_one	
}
...
{		
	...
	sprintf(temp,"Gas detected");//构建报文
...
{		
	...
	sprintf(temp,"Fire detected");//构建报文

...
void TIM2_IRQHandler(void)
{
	...
	{ 
		...
		OLED_Clear();
		OLEDShowData();
		OLED_ShowNum(50,0,temperature,2,16,1);     //显示温度值
		OLED_ShowNum(50,16,humidity,2,16,1); 
		OLED_ShowNum(80,34,(ADC_Val/100),2,16,1); 		//显示湿度值
		OLED_ShowString(68,16,"%",16,1);  
		OLED_ShowString(100,34,"ppm",16,1);
		OLED_Refresh();
		//DelayMs(1000);
   ...
   sprintf(temp, "{\"smoke\":\"%d\",\"temp\":\"%d\",\"humi\":\"%d\"}", (ADC_Val/100), temperature, humidity);    //构建报文
